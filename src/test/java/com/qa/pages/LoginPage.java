...
/**
 * @author HP
 * Login page factory class with element repository and page operation method
 *
 */
...
WebElement homepageTitle;
	...
	/**
	 * @param driver- this is constructor of class which initialize global driver variable
	 */
	...
	/** this method enters the username and password and return expected text from the home page
	 *  which verifies the the user logged in successfully
	 * 
	 */
